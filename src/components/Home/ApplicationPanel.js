            ...
            <Row>
                ...
                <Col md="4" sm="4" xs='4' className={classes.columnPadding}>
                    ...
                    <Row className={classes.applicationPanelRow}>
                        ...
                        <Col lg="10" md="10" sm="10" xs='10'>
                            ...
                            <p className={classes.pTagMargin}><a className={classes.anchorTag + ' appLink'} href={process.env.REACT_APP_API_URL + url.patentNumLink} target="_blank" rel="noreferrer">{t('patentNumbers')}</a></p>
                        </Col>
                    </Row>
                    ...
                    <Row className={classes.applicationPanelRow}>
                        ...
                        <Col lg="10" md="10" sm="10" xs='10'>
                            <p className={classes.pTagMargin}><a className={classes.anchorTag + ' appLink'} href={process.env.REACT_APP_API_URL + url.browserDBLink} target="_blank" rel="noreferrer">{t('browseDatabases')}</a></p>
                            <p className={classes.pTagMargin}>
                ...
                <Col md="4" sm="4" xs='4' className={classes.columnPadding}>
                    ...
                    <Row className={classes.applicationPanelRow}>
                        ...
                        <Col lg="10" md="10" sm="10" xs='10'>
                            <p className={classes.pTagMargin}><a className={classes.anchorTag + ' appLink'} href={process.env.REACT_APP_API_URL + url.alignSequencesDirectly} target="_blank" rel="noreferrer">{t('alignSequencesDirectly')}</a></p>
