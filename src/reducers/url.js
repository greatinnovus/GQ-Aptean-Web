export const url = {
    ...
    news: "do=mygq.get_news_bullet&format=text/plain",
    seqSearchInit: "do=gqft.launch_seq_search&format=json",
    seqSearchSubmit: "do=gqworkflow.submit_seq_search&format=json",
    mostRecentTypeUrl:"resultsummNew/index.html#/resbrowse/",
    mostRecentClassicUrl:"do=gqresult&is_workspace_recognized=1&def_view=query",
